...
if(isset($_POST['login'])){
	...
	if (mysqli_num_rows($hasil) == 0) {
		...
		if($row['level'] == "produksi" && $level == "produksi"  ) {
			$_SESSION['login'] = true;
		...
		<div class='row' style='margin-top: 15px';>
	       <div class='col-md-12'>
	        	<div class='box box-solid bg-red'>
	        		...
	        		<div class='box-body'>
	        			<p>Anda belum memilih atau salah memilih level login.</p>
	        		</div>
			    </div>
			 </div>
		 </div>
...
<body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
      	<h3 class="text-center">Aplikasi Permintaan Barang Gudang</h3>
      	<img src="gambar/logosharp.png" style="width: 180px; height: 60px;">        
        <form method="post">
	...
	<marquee hspace="50" width="full-width">Untuk Pendaftaran Akun silahkan Leader Menghadap Admin Gudang PT. SHARP !!!</marquee>
        </form>
