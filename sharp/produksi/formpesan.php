                ...
                <form method="post" id="tes"  action="add-proses.php" class="form-horizontal">
                    <div class="box-body">
                        <div class="form-group ">
                            <label for="nama_brg" class="a col-sm-3 control-label">Nama Akun</label>
                            <div class="col-sm-3">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input id="nama_karyawan" type="text" required="isi nama karyawan yg mengambil barang" class="form-control" name="nama_karyawan" required>                                
                            </div>
                        </div>            
                        <div class="form-group">
                        <label for="sift" class=" col-sm-3 control-label">Jam Kerja</label>
                        <div class="col-md-5">          	
                            <select id="sift" required="isikan dulu" class="form-control" name="sift">           	
                                <option value>-Pilih Jam Kerja-</option>
                                <option value="sift 1">Sift 1</option>
                                <option value="sift 2">Sift 2</option>
                                <option value="sift 3">Sift 3</option>
                            </select>
                    </div>
                            <span class="col-sm-7"> <?php echo $error; ?></span>
                        </div>
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <table class="table table-responsive">
                        ...
                        <?php 
                            $sekarang  = date("Y-m-d");
                            $queryTampil = mysqli_query($koneksi, "SELECT sementara.unit, sementara.nama_karyawan, sementara.id_sementara, stokbarang.nama_brg, stokbarang.satuan, jumlah, sift FROM sementara INNER JOIN stokbarang ON sementara.kode_brg  = stokbarang.kode_brg WHERE tgl_permintaan = '$sekarang' AND sementara.unit='$_SESSION[username]' "  );
                            $no = 1;
