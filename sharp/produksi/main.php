      ...
      <div class="row">
		...
		<div class="col-lg-4 col-xs-12">
          ...
          <div class="small-box bg-green">
            ...
            <a href="index.php?p=barang" class="small-box-footer">Info Lebih Lanjut <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
			      <p>1. Leader Produksi menginput data permintaan barang  di form permintaan barang .</p>
			    	<p>2. Leader Produksi menunggu permintaan di konfirmasi oleh Admin Gudang.</p>
				    <p>3. Setelah di konfirmasi, kemudian Leader Produksi mencetak BPB dan kemudian membawa BPB yang telah di tanda tanggan ke Gudang sebagai bukti proses pengeluaran barang.</p>
				</div>
				<!-- footer modal -->
