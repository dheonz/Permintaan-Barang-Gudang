    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2 col-xs-12">
            <div class="box box-primary">
                ...
                <form method="post"  action="pesanan/edit_proses.php" class="form-horizontal">
                    <div class="box-body">
                    	<input type="hidden" name="id" value="<?= $row2['id_permintaan']; ?>">
                    	<input type="hidden" name="tgl_permintaan" value="<?= $row2['tgl_permintaan']; ?>">                    	
                        <div class="form-group ">
                            <label for="nama_brg" class="col-sm-offset-1 col-sm-3 control-label">Leader</label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            &nbsp;
                            <a href="index.php?p=datapesanan" class="btn btn-danger btn-lg">Batal</a>			  
