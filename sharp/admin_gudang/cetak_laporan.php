...
<table>
  ...
  <hr>
  <p align="center" style="font-size: 18px;"><b><u>LAPORAN PERMINTAAN BARANG</u></b></p><br>No : ....../Sharp-Adm/BP/<?= $currentTime1; ?></p><br><br>
  <?php
       $from=$_POST['from'];
       $end=$_POST['end'];
  ...
  <br>
  <p style="margin: 0 570;">Karawang, <?=  tanggal_indo($currentTime); ?></p>
  <div class="kiri">
