    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2 col-xs-12">
            <div class="box box-primary">
                <a href="index.php?p=barang" style="margin:10px;" class="btn btn-success"><i class='fa fa-backward'>  Kembali</i></a>
                <div class="box-header with-border">
                    <h3 class="text-center">Update Data Stok Barang </h3>
                </div>
                <form method="post"  action="index.php?p=edit_proses" class="form-horizontal">
                    <div class="box-body">
